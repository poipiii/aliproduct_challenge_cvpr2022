...
from data.aliproduct2_dataset import aliproduct2_train,aliproduct2_caption_eval,aliproduct2_retrieval_eval
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset=='retrieval_aliproduct2': 
        train_dataset = aliproduct2_train(transform_train, config['image_root'], config['ann_root'])
        val_dataset = aliproduct2_retrieval_eval(transform_test, config['image_root'], config['ann_root'],'val')
        test_dataset = aliproduct2_retrieval_eval(transform_test, config['image_root'], config['ann_root'],'test')     
        return train_dataset, val_dataset, test_dataset 
