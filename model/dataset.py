...
def prepare_data(df_path,image_data_dir,image_data_folder,image_col,label_col,batch_size,preprocess,random_state,split_size=0.2,test=False,use_all=False,tokenize=True):
    ...
    if test:
        ...
        test_dataloader = DataLoader(test_data,batch_size,num_workers=8,pin_memory=True,shuffle=False)
        ...
        if use_all:
            ...
            train_dataloader = DataLoader(train_data,batch_size,shuffle=False,num_workers=8,pin_memory=True)
            ...
            train_dataloader = DataLoader(train_data,batch_size,shuffle=False,num_workers=8,pin_memory=True)
            val_dataloader = DataLoader(val_data,batch_size,shuffle=False,num_workers=8)
